...
export default function ProjectPreview({ variant }: ProjectPreviewProps) {
  if (variant === "blog") {
    return (
      <div className="relative h-56 overflow-hidden border-b border-white/10 bg-black/45">
        {/* browser bar */}
        <div className="flex items-center gap-2 border-b border-white/10 bg-black/50 px-4 py-3">
          ...
          <div className="ml-3 h-6 flex-1 rounded-full border border-white/10 bg-white/[0.04]" />
        </div>

        {/* mini website */}
        <div className="relative p-5">
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_30%_20%,rgba(52,211,153,0.16),transparent_45%)]" />
  ...
  if (variant === "restaurant") {
    return (
      <div className="relative h-56 overflow-hidden border-b border-white/10 bg-black/45">
        ...
        {/* mini website */}
        <div className="relative p-5">
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_70%_30%,rgba(251,191,36,0.18),transparent_45%)]" />
